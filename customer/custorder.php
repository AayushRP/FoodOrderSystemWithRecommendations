...
<div class="container">
	<h1 class="page-header text-center">RECOMMENDED ITEMS</h1>

	<?php

		$sql="select * from recom_details order by similarity DESC LIMIT 4";
	...
	<form method="POST" action="purchase.php">
		...
		<div class="row">
			...
			<div class="col-md-2" style="float: right;">
				<button type="submit" class="btn btn-primary" style="margin-left: 85px;"><span class="glyphicon glyphicon-floppy-disk"></span> Order</button>
			</div>
		</div>
	</form>
</div>
