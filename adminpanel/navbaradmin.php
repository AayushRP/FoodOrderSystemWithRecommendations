<?php
  $sql = "select * from current_logged_admin";
...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="indexadmin.php"><b>Bhok Lagyo</b></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="welcome"><a href="indexadmin.php">Welcome <?php echo $row['email']; ?></a></li>
        ...
        <li>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="categoryadmin.php">Category</a></li>
          </ul>
        </li>
